...
> **已弃用**，请使用 `createSeparatorFormatter`。
...
- 新代码请直接使用 `createSeparatorFormatter`
- 旧代码兼容（仍可使用）

## 不适用场景

- 新项目 → 用 `createSeparatorFormatter`
...
- `createSeparatorFormatter` — 替代函数，功能相同
