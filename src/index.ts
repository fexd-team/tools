...
export { default as isReactValidElement } from './isReactValidElement'
...
/** @deprecated 请使用 depsChanged */
export { default as compare } from './depsChanged'
...
/** @deprecated 请使用 createCachedRequest */
